...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
top:	sys	clear		;clear text video


;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; When read from GPIO, SW(7..0) are in bits 7 downto 0
;; 	Assuming that NumA = SW(7 downto 4) and NumB = SW(3 downto 0)
;;	are both unsigned numbers (range from 0 to 15)
;;	HINT: use AND and ROR
;;
;; When write to GPIO, the 32-bit number is displayed as 8 hex digits
;;	However, only 4 digits at a time are displayed. the lower four digits
;; 	by default and the higher for when key(3) is pressed
;;
;; Prog output:
;;	  i. if NumA<NumB then write 0x12345678 to 7-seg displays
;;	 ii. if NumA=NumB then write 0x01010101 to 7-seg displays
;; 	iii. if NumA>NumB then write 0x87654321 to 7-seg displays
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
